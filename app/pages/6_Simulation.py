...
hero(
    ...
    "Every probability on this page is the frequency of an "
...
metric_row(
    [
        ...
        (
            "Title favorite",
            str(sims.iloc[0]["team"]),
            f"{sims.iloc[0]['champion_prob']:.1%}",
        ),
        (
            "Dark horse",
            str(sims.iloc[min(7, len(sims) - 1)]["team"]),
