...
hero(
    "MLOps Dashboard",
    "Deep visibility into the machine learning lifecycle, training metadata, cross-validation leaderboards, and feature distributions.",
)
...
c3.metric(
    "Train Window", f"{metadata['train_years'][0]} - {metadata['train_years'][1]}"
)
...
st.caption(
    "Note: Calibration (Platt Scaling) is only applied if it strictly improves both Log Loss and Brier Score over the raw estimator."
)
